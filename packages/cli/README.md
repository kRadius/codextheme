...
```sh
npx --yes @codextheme/cli@0.2.7 apply cathedral-nocturne
```

The custom skin studio at [codextheme.tech](https://codextheme.tech) creates an expiring private command:

```sh
npx --yes @codextheme/cli@0.2.7 apply-private <private-id>
```
