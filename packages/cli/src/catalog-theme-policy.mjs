...
export const CATHEDRAL_ICON_ANCHORS = Object.freeze([
  ...
  { id: "icon-explore", contexts: ["home"], selector: ".dream-home .group\\/home-suggestions button:nth-child(1) svg", min: 0, max: 1 },
  { id: "icon-build", contexts: ["home"], selector: ".dream-home .group\\/home-suggestions button:nth-child(2) svg", min: 0, max: 1 },
  { id: "icon-review", contexts: ["home"], selector: ".dream-home .group\\/home-suggestions button:nth-child(3) svg", min: 0, max: 1 },
  { id: "icon-fix", contexts: ["home"], selector: ".dream-home .group\\/home-suggestions button:nth-child(4) svg", min: 0, max: 1 },
