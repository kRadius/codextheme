...
export function SiteFooter() {
  return (
    <footer className="site-footer">
      ...
      <nav className="footer-links" aria-label="页脚导航"><Link href="/security">安全边界</Link><Link href="/help">安装帮助</Link><a href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a><a href={SUBMIT_THEME_URL} rel="noreferrer">提交主题</a><a href={REPOSITORY_URL} rel="noreferrer">GitHub</a></nav>
