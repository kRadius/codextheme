...
const packages = [
  { name: "@codextheme/runtime", version: "0.1.3", directory: "packages/runtime" },
  { name: "@codextheme/cli", version: "0.2.9", directory: "packages/cli" },
];
...
function checkManifest(expected, manifest) {
  ...
  if (expected.name === "@codextheme/cli") {
    if (manifest.dependencies?.["@codextheme/runtime"] !== "0.1.3") {
      fail("CLI must depend on the exact @codextheme/runtime 0.1.3 release.");
    }
