...
const packages = [
  { name: "@codextheme/runtime", version: "0.1.4", directory: "packages/runtime" },
  { name: "@codextheme/cli", version: "0.2.10", directory: "packages/cli" },
];
...
function checkManifest(expected, manifest) {
  ...
  if (expected.name === "@codextheme/cli") {
    if (manifest.dependencies?.["@codextheme/runtime"] !== "0.1.4") {
      fail("CLI must depend on the exact @codextheme/runtime 0.1.4 release.");
    }
